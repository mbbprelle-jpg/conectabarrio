...
<div class="sidebar" id="sidebar">
    ...
    } elseif (AuthContext::sessionCargo() !== '') {
        $cargoKey = AuthContext::sessionCargo();
        $sidebarRoleLabel = $cargoLabels[$cargoKey] ?? ucfirst(strtolower($cargoKey));
    }
    ...
    <ul class="sidebar-menu">
        <?php if ($_SESSION['user_rol'] === 'maestro'): ?>
            ...
            <?php if (!empty($_SESSION['maestro_acting_junta_id'])): ?>
            <li class="sidebar-menu-group"><span>Finanzas · <?php echo htmlspecialchars($_SESSION['maestro_acting_junta_nombre'] ?? 'Organización'); ?></span></li>
            ...
            <li class="sidebar-menu-item <?php echo (isset($data['active_menu']) && $data['active_menu'] === 'reporte_movimientos') ? 'active' : ''; ?>">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo URLROOT; ?>/maestro/finanzas_salir">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                    <span>Volver al portal maestro</span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <?php if (AuthContext::canManageVotaciones()): ?>
            <li class="sidebar-menu-item <?php echo (isset($data['active_menu']) && $data['active_menu'] === 'votaciones') ? 'active' : ''; ?>">
                <a href="<?php echo URLROOT; ?>/admin/votaciones">
        ...
        <?php elseif ($_SESSION['user_rol'] === 'socio'): ?>
            ...
            <?php if (AuthContext::canManageSocios() || AuthContext::canViewCensoFamiliar() || AuthContext::canViewMapaSocios()): ?>
            <li class="sidebar-menu-group"><span>Comunidad</span></li>
            <?php endif; ?>
            ...
            <li class="sidebar-menu-item <?php echo (isset($data['active_menu']) && $data['active_menu'] === 'votaciones') ? 'active' : ''; ?>">
                <a href="<?php echo URLROOT; ?>/socio/votaciones">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
                    <span>Votaciones</span>
                </a>
            </li>
