...
class AuthController extends Controller {
    ...
    // Acción temporal segura para ejecutar todas las migraciones contables, comerciales y estructurales
    public function migrar_planes() {
        ...
        try {
            ...
            // 1. Verificar columnas en 'juntas_vecinos'
            ...
            if (!$hasTipo) {
                echo "Añadiendo columna 'tipo' a 'juntas_vecinos'...<br>";
                $db->query("ALTER TABLE juntas_vecinos ADD COLUMN tipo VARCHAR(50) NOT NULL DEFAULT 'Junta de Vecinos' AFTER nombre");
                $db->execute();
                echo "✓ Columna 'tipo' agregada con éxito.<br>";
            } else {
                echo "✓ La columna 'tipo' ya existe.<br>";
            }
            ...
            $db->query("UPDATE juntas_vecinos SET plan = 'premium', precio_anual = 119880, tipo = 'Junta de Vecinos' WHERE id = 1");
            $db->execute();
